...
class HybridBettingTest(WagerrTestFramework):
    ...
    def check_mapping(self):
        ...
        for node in self.nodes:
            ...
            # Check individualSports mapping
            for id in range(len(field_sport_names)):
                ...
                assert_equal(mapping['mapping-index'], id)
                mappingid = node.getmappingid("individualSports", field_sport_names[id])[0]
                assert_equal(mappingid['exists'], True)
    ...
    def check_hybrid_parlay_bets(self):
        ...
        # invalid amount
        #breakpoint()
        #assert_raises_rpc_error(-131, "Incorrect bet amount. Please ensure your bet is between 25 - 10000 WGR inclusive.", self.nodes[2].placeparlaybet(player1_legs, 24))
        #assert_raises_rpc_error(-131, "Incorrect bet amount. Please ensure your bet is between 25 - 10000 WGR inclusive.", self.nodes[2].placeparlaybet(player1_legs, 10001))
