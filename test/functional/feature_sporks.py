...
class SporkTest(WagerrTestFramework):
    def set_test_params(self):
        ...
        self.extra_args = [["-sporkkey=6xLZdACFRA53uyxz8gKDLcgVrm5kUUEu2B3BUzWUxHqa2W7irbH"], ["-sporkkey=6xLZdACFRA53uyxz8gKDLcgVrm5kUUEu2B3BUzWUxHqa2W7irbH"], ["-sporkkey=6xLZdACFRA53uyxz8gKDLcgVrm5kUUEu2B3BUzWUxHqa2W7irbH"]]
    ...
    def run_test(self):
        ...
        for i in range(self.num_nodes):
           ...
           self.set_test_spork_state(self.nodes[1], spork_new_state)
           self.set_test_spork_state(self.nodes[2], spork_new_state)
        ...
        assert self.get_test_spork_state(self.nodes[2]) == spork_new_state
