...
class TxnMallTest(WagerrTestFramework):
    ...
    def run_test(self):
        ...
        # First: use raw transaction API to send 12400 WAGERR to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 500 WAGERR coin each
        ...
        # Node0's balance should be starting balance, plus 500WAGERR for another
        ...
        # Node0's total balance should be starting balance, plus 1000WAGERR for
