...
class BlockchainTest(WagerrTestFramework):
    ...
    def run_test(self):
        self.mine_chain()
        self.stop_node(0)
        self.start_node(0, extra_args=['-stopatheight=238', '-prune=1', '-txindex=0', '-disablegovernance'])  # Set extra args with pruning after rescan is complete
    ...
    def _test_getblockchaininfo(self):
        ...
        assert_equal(sorted(res.keys()), sorted(['moneysupply', 'pruneheight', 'automatic_pruning'] + keys))
