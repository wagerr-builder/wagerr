...
class CompactBlocksTest(WagerrTestFramework):
    ...
    # This test actually causes wagerrd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that wagerrd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for wagerrd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # wagerrd will not send blocktxn responses for blocks whose height is
