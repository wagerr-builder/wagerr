...
class DeriveaddressesTest(WagerrTestFramework):
    ...
    def run_test(self):
        ...
        descriptor = descsum_create("pkh(tprv8ZgxMBicQKsPd7Uf69XL1XwhmjHopUGep8GuEiJDZmbQz6o58LninorQAfcKZWARbtRtfnLcJ5MQ2AtHcQJCCRUcMRvmDUjyEmNUWwx8UbK/1/1/0)pkh([6ecdc6da]029c19ca51777c8a2940fbe2e9f6bd7156227e1c53ed08447ba8d5a5deb08d97d6)#xtu8cag9")
