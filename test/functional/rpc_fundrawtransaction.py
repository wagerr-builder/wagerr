...
class RawTransactionsTest(WagerrTestFramework):
    ...
    def test_locked_wallet(self):
        ...
        # Make sure funds are received at node1.
        assert_equal(oldBalance+Decimal('11.0000000'), self.nodes[0].getbalance())
    ...
    def test_many_inputs_send(self):
        ...
        self.nodes[1].generate(1)
        self.sync_all()
        assert_equal(oldBalance+Decimal('0.19000000'), self.nodes[0].getbalance()) #0.19+block reward
