...
class ScantxoutsetTest(WagerrTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress("TVEfNVgrMhPSyR3qRJb5keYxLQ6soLywTf", 0.008) # (m/0'/0'/0')
        self.nodes[0].sendtoaddress("TC59R344jR3DQPQz3U3nPdpsm7jz4JBiEr", 0.016) # (m/0'/0'/1')
        self.nodes[0].sendtoaddress("TEAn6cxM3VT8NiwbemALjW6ovW56Uck7fy", 0.032) # (m/0'/0'/1500')
        self.nodes[0].sendtoaddress("TSrWpHFUvHDkJUiVc5EWaixcUiZqcD8zJd", 0.064) # (m/0'/0'/0)
        self.nodes[0].sendtoaddress("TDTdsasodV476XW4VCRxAUsjoXZb2CTMTd", 0.128) # (m/0'/0'/1)
        self.nodes[0].sendtoaddress("TAzmdMjdtCgk3PcG5iVetjphTZBRLMy3gp", 0.256) # (m/0'/0'/1500)
        self.nodes[0].sendtoaddress("TG5Fd7s56Srax4D9hNVAAqCvjh5de5jX7p", 0.512) # (m/1/1/0')
        self.nodes[0].sendtoaddress("TP21TLgDY8DTegWAQTDzVo5hZKbr3Lkbb8", 1.024) # (m/1/1/1')
        self.nodes[0].sendtoaddress("TKxLUevkwSr2qvMgxK46XTXfEAMirxSPsU", 2.048) # (m/1/1/1500')
        self.nodes[0].sendtoaddress("TVmCDRHXiuizGaynaNgJzjUzYNbHYaaYyj", 4.096) # (m/1/1/0)
        self.nodes[0].sendtoaddress("TEHbfjsmP4GMDWKgSBtm2QeZ1QMxuo7gjV", 8.192) # (m/1/1/1)
        self.nodes[0].sendtoaddress("TMv4xFJ1H6SB89Cbx4DEmNpWuNNywT5n35", 16.384) # (m/1/1/1500)
