...
class DIP3Test(WagerrTestFramework):
    ...
    def register_fund_mn(self, node, mn):
        ...
        mn.protx_hash = node.protx('register', collateral_txid, mn.collateral_vout, '127.0.0.1:%d' % mn.p2p_port, mn.ownerAddr, mn.operatorAddr, mn.votingAddr, 0, mn.rewards_address, mn.fundsAddr)
